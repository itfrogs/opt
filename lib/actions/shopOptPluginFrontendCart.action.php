...
class shopOptPluginFrontendCartAction extends shopFrontendAction
{
    public function execute()
    {
        ...
        if (waRequest::post('checkout')) {
            ...
            if (!$errors) {
                ...
                $this->redirect(shopOptPluginViewHelper::getCheckoutUrl());
            }
        }
        ...
        $themePath = shopOptPluginViewHelper::getThemePath();
        $this->setTemplate($themePath . '/cart.html');
    }
